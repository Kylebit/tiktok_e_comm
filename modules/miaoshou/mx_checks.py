...
MX_EXIT_VOLUMETRIC_NEEDS_CONFIRM = 4
...
def format_volumetric_warning(quote: Any) -> str:
    ...
    return (
        ...
        f"计费 {quote.billable_kg}kg，藏价 {quote.logistics_hidden_mxn} MXN，"
        f"POP 折后 {quote.sale_price_mxn:.2f} MXN。"
