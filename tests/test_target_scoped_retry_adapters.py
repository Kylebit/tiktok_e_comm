...
def test_shopee_proof_is_full_scan_no_refresh_and_vn_filters_50052(monkeypatch):
    ...
    monkeypatch.setattr("modules.shopee.target_scoped.inspect_existing_global", lambda **_kw: {"global_model_id": "1", "tier_index": [0], "summary": {"global_image_snapshot_digest": "a" * 64}, "image_observation": {"status": "warning"}, "image_outcome": {"execution_allowed": True}})
